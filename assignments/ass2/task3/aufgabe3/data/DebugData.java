...
public class DebugData {
    ...
    public double distance(DebugData other) {
        return Math.sqrt(Math.pow(this.x - other.x, 2) + Math.pow(this.y - other.y, 2)); //Math.pow -> Math.sqrt(..., 2) cause Phytagoras
    }
    ...
    public String str() {
        return String.format("(%f, %f)", this.x, this.y); //Muss f sein statt g weil man sonst nicht auf die sozial konstruierten 6 Fehler kommt 
    }
}